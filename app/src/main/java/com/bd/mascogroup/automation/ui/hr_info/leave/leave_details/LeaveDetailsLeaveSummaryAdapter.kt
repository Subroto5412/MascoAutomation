...
class LeaveDetailsLeaveSummaryAdapter @Inject constructor(private val context: Context, val mLeaveSummaryCardData: ArrayList<LeaveSummaryCardData>, val dataManager: IDataManager) : RecyclerView.Adapter<BaseViewHolder>() {
